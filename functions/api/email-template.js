...
<tr><td style="background:#f8f6f2;padding:28px 28px 22px;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
        ...
        <td style="padding-right:10px;vertical-align:middle;">
            <a href="https://instagram.com/orlostore" aria-label="Instagram" style="text-decoration:none;"><img src="https://orlostore.com/icons/instagram.png" alt="Instagram" width="14" height="14" border="0" style="display:block;width:14px;height:14px;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a>
        </td>
        <td style="vertical-align:middle;">
            <a href="https://tiktok.com/@shoporlo" aria-label="TikTok" style="text-decoration:none;"><img src="https://orlostore.com/icons/tiktok.png" alt="TikTok" width="14" height="14" border="0" style="display:block;width:14px;height:14px;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a>
        </td>
    </tr></table>
...
function siteHeader(origin) {
    ...
    return `<tr><td style="background:${C.white};border-bottom:1px solid ${C.hairline};padding:14px 24px;">
        <table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
            <td style="vertical-align:middle;"><img src="${logoUrl}" alt="ORLO" height="32" width="32" style="display:block;height:32px;width:32px;border:0;"></td>
            <td style="vertical-align:middle;padding:0 14px;"><div style="width:1px;height:24px;background:rgba(26,58,82,0.25);font-size:1px;line-height:1px;">&nbsp;</div></td>
            <td style="vertical-align:middle;font-family:${F_SERIF};font-weight:600;font-size:20px;letter-spacing:0.1em;color:${C.navy};line-height:1;">ORL<span style="color:${C.coral};">O</span></td>
        </tr></table>
    </td></tr>`;
}
