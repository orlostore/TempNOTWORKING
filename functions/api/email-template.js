...
<tr><td style="background:#f8f6f2;padding:28px 28px 22px;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
        ...
        <td style="padding-right:10px;vertical-align:middle;">
            <a href="https://instagram.com/orlostore" aria-label="Instagram" style="text-decoration:none;"><img src="https://orlostore.com/icons/instagram.png" alt="Instagram" width="28" height="28" border="0" style="display:block;width:28px;height:28px;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a>
        </td>
        <td style="vertical-align:middle;">
            <a href="https://tiktok.com/@shoporlo" aria-label="TikTok" style="text-decoration:none;"><img src="https://orlostore.com/icons/tiktok.png" alt="TikTok" width="28" height="28" border="0" style="display:block;width:28px;height:28px;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a>
        </td>
    </tr></table>
