...
function buildCustomerSample(template, origin) {
    const samples = {
        orderConfirmed: {
            ...
            ctaUrl: `${origin}/account.html`, ctaText: 'View My Orders | عرض طلباتي',
        ...
        shipped: {
            ...
            ctaUrl: `${origin}/track?awb=XYZ123`, ctaText: 'Track My Order | تتبع طلبي',
        ...
        verify: {
            ...
            ctaUrl: `${origin}/verify?token=sample`, ctaText: 'Verify Email | تأكيد البريد',
        ...
        reset: {
            ...
            ctaUrl: `${origin}/reset?token=sample`, ctaText: 'Reset Password | إعادة التعيين',
