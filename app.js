    ...
    if (!overlay) {
        ...
        overlay.innerHTML = `
            <div class="mobile-menu">
                ...
                <div class="menu-head">Navigate</div>
                ...
                <a href="terms-and-conditions.html#contact" onclick="closeMobileMenu()">
                    ...
                    <div class="menu-text"><span class="menu-en">Customer Enquiries</span><span class="menu-ar">اتصل بنا</span></div>
                </a>
                <a href="terms-and-conditions.html#terms" onclick="closeMobileMenu()">
...
const CATEGORY_SVG = {
    'Kitchen':      '<rect x="4" y="5" width="16" height="14" rx="1.5"/><line x1="4" y1="12" x2="20" y2="12"/><circle cx="6.5" cy="8.5" r="0.6" fill="currentColor"/><circle cx="6.5" cy="15.5" r="0.6" fill="currentColor"/>',
    'Home':         '<rect x="2.5" y="7" width="19" height="13" rx="1"/><circle cx="7.5" cy="13.5" r="2.6"/><line x1="13" y1="11" x2="19" y2="11"/><line x1="13" y1="13.5" x2="19" y2="13.5"/><line x1="13" y1="16" x2="19" y2="16"/><line x1="6" y1="7" x2="6" y2="4"/><line x1="18" y1="7" x2="18" y2="4"/>',
    'Lifestyle':    '<rect x="6" y="3" width="12" height="18" rx="0.5"/><rect x="8" y="5" width="8" height="9"/><line x1="9" y1="17.5" x2="15" y2="17.5"/>',
    'Bathroom':     '<path d="M10 2 L14 2 L14 5 L16 8 L16 20 C16 21.1 15.1 22 14 22 L10 22 C8.9 22 8 21.1 8 20 L8 8 L10 5 Z"/><line x1="9" y1="2" x2="15" y2="2"/><line x1="8" y1="13" x2="16" y2="13"/>',
    'Organization': '<path d="M3 17 C3 17 6 20 12 20 C18 20 21 17 21 17 L19 11 L5 11 Z"/><line x1="5" y1="11" x2="19" y2="11"/><path d="M9 8 C9 6 13 6 13 9 C13 12 16 12 16 8"/>',
    'Storage':      '<rect x="3" y="13" width="18" height="8" rx="0.5"/><rect x="5.5" y="5" width="13" height="8" rx="0.5"/><line x1="3" y1="17" x2="21" y2="17"/><line x1="5.5" y1="9" x2="18.5" y2="9"/><line x1="11" y1="13" x2="13" y2="13"/>',
...
async function checkout() {
    ...
    try {
        ...
        // Meta Pixel + CAPI: InitiateCheckout (deduplicated via shared event_id).
        // Goes through orloTrack so it queues if fbq hasn't loaded yet.
        if (typeof window.orloTrack === 'function') {
            ...
            window.orloTrack('InitiateCheckout', {
